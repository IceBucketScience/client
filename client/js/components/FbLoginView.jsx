...
module.exports = React.createClass({
    ...
    render: function() {
        return <div className="text-center">
            <div className="row"><div className="col-sm-12"><p className="lead">Please click the button below to have my server analyze your network.</p><p>If you've already had your network indexed before, you can still click this button to reload the visualization of your network.</p></div></div>
